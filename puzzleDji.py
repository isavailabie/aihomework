...
def visualize_search(history, path_history, maze, algorithm_name="Dijkstra"):
    """Dijkstra可视化，与A*风格一致"""
    ...
    ani.save(
        "dijkstra_pathfinding.gif",
        writer=writer,
        dpi=100,
        savefig_kwargs={'facecolor': 'white'}
    )
    print("GIF动画已保存为 dijkstra_pathfinding.gif")
...
# 执行搜索和可视化
history, path_history, path_length = dji_search(maze)
print(f"最短路径长度: {path_length}")
visualize_search(history, path_history, maze, "Dijkstra")